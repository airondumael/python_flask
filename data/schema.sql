...
CREATE TABLE `tracks` (
    ...
    `title` varchar(1000) COLLATE utf8_unicode_ci DEFAULT '',
    `artist` varchar(1000) COLLATE utf8_unicode_ci DEFAULT '',
    `album` varchar(1000) COLLATE utf8_unicode_ci DEFAULT '',
    `genre` varchar(1000) COLLATE utf8_unicode_ci DEFAULT '',
    `mood` varchar(1000) COLLATE utf8_unicode_ci DEFAULT '',
    `instrument` varchar(1000) COLLATE utf8_unicode_ci DEFAULT '',
